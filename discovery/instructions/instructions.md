...
- [Addendum 009 — The list reads across, not down](./addendum-009-recovery-table-density.md) — two cells were stacking five columns' worth of fields, costing 97px a row while a third of the width sat empty; cause and phone become columns and every cell is one line, halving the row to 43px
